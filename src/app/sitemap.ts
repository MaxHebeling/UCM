...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = ["", "/nosotros", "/oferta", "/claustro-docente", "/admisiones", "/costos-y-becas", "/respaldos", "/contacto", "/referidos", "/aviso-de-privacidad", "/preparatoria/plan-de-estudios", "/encuentra-tu-programa"];

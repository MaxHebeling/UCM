...
export const metadata: Metadata = {
  ...
  description: "Conoce al claustro docente de la UCM: jueces del Poder Judicial en la Maestría en Juicios Orales y directivos empresariales en la MADAN. Experiencia real en el aula.",
